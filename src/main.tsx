...
function Home() {
  return <>
    ...
    <section className="featured-strip section-pad" aria-label="Brands explored through independent product studies"><span>INDEPENDENT PRODUCT STUDIES</span><p>TRACE · PHIL’S · HARRY’S · EO · ACURE · OM</p></section>
    <Work/><Studio/><Contact/>
  </>;
}
